...
export function SearchBar() {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-[1000] px-3"
      ...
      <div className="flex items-center gap-2"
        ...
        <span className="text-[13px] font-black text-[#0077b6] shrink-0 tracking-tight">
          🛒 LocalCart
        </span>

        <div className="h-4 w-px bg-[#1a2233]/15 shrink-0" />
        ...
        <input
          ...
          className="flex-1 bg-transparent text-[13px] text-[#1a2233] placeholder:text-[#8a96b0] outline-none min-w-0"
        />
      ...
      {hint && (
        <div className="mt-1.5 mx-2 rounded-full px-4 py-1 text-[12px] w-fit"
          style={{
