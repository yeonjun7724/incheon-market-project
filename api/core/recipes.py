...
_PORTION_OVERRIDE: dict[str, tuple] = {
    ...
    "파프리카":          ("1개",          0.33),
    "브로콜리":          ("1/2개",        0.50),
    "돼지고기앞다리":    ("300g",         3.00),  # KAMIS=100g 기준
    "닭가슴살":          ("300g",         0.30),  # KAMIS=1kg 기준
    "소고기":            ("150g",         1.50),
    "계란":              ("6개",          0.20),  # KAMIS=30구 기준
    "쌀":                ("2인분(400g)", 0.02),  # KAMIS=20kg 기준
    "사과":              ("1개",          0.10),  # KAMIS=10개 기준
    "바나나":            ("1/2송이(500g)", 5.00), # KAMIS=100g 기준
